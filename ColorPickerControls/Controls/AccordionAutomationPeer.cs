...
namespace ColorPickerControls.Controls
{
    ...
    public class AccordionAutomationPeer : ItemsControlAutomationPeer, ISelectionProvider
    {
        ...
        protected override List<AutomationPeer> GetChildrenCore()
        {
            ...
            {
                var element = owner.ItemContainerGenerator.ContainerFromIndex(i) as AccordionItem;
                if (element != null)
                {
        ...
        public IRawElementProviderSimple[] GetSelection()
        {
            ...
            var selection = new List<IRawElementProviderSimple>(owner.SelectedIndices.Count);

            foreach (int index in owner.SelectedIndices)
            {
                var item = owner.ItemContainerGenerator.ContainerFromIndex(index) as AccordionItem;
                if (item != null)
                {
