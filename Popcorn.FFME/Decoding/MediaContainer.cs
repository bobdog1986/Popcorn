...
#pragma warning restore SA1401 // Fields must be private
        ...
        /// </summary>
        /// <exception cref="Popcorn.FFME.MediaContainerException">The exception ifnromation</exception>
        ...
        private MediaType StreamRead()
        {
            ...
            if (RequiresPictureAttachments)
            {
                ...
                var copyPacketResult = ffmpeg.av_packet_ref(attachedPacket, &Components.Video.Stream->attached_pic);
